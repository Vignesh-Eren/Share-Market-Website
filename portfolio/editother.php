...
mysqli_query($db,"UPDATE other SET product_name='$name', price='$price' ,quantity='$quant',tot='$tot',date='$date' WHERE product_id='$id'");
...
$id = $_GET['id'];
$result = mysqli_query($db,"SELECT * FROM other WHERE product_id=".$_GET['id']);
...
<form action="" method="post" action="editother.php">
