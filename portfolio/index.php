...
<body>
    ...
    <div class="page-container">
		...
		<?php
			   ...
			   $query = "SELECT SUM(tot) AS sum1 FROM `stock` WHERE username='".$_SESSION['username']."'";
			   ...
			   $query = "SELECT SUM(tot) AS sum2 FROM `fund` WHERE username='".$_SESSION['username']."'";
               $query_result = mysqli_query($conn , $query);
			   while($row = mysqli_fetch_assoc($query_result)){
				   $output2 =$row['sum2'];
			   }
			   ...
			   $query = "SELECT SUM(tot) AS sum3 FROM `comd` WHERE username='".$_SESSION['username']."'";
               $query_result = mysqli_query($conn , $query);
			   while($row = mysqli_fetch_assoc($query_result)){
				   $output3 =$row['sum3'];
			   }
			   ...
			   $query = "SELECT SUM(tot) AS sum4 FROM `cur` WHERE username='".$_SESSION['username']."'";
               $query_result = mysqli_query($conn , $query);
			   while($row = mysqli_fetch_assoc($query_result)){
				   $output4 =$row['sum4'];
			   }
			   ...
			   $query = "SELECT SUM(tot) AS sum5 FROM `other` WHERE username='".$_SESSION['username']."'";
               $query_result = mysqli_query($conn , $query);
			   while($row = mysqli_fetch_assoc($query_result)){
				   $output5 =$row['sum5'];
			   }
				   ...
				   <button style="font-size:30px" type="button" class="btn btn-success"><?php 
						   ...
						   echo "TOTAL INVESTMENT : ₹",$output1 + $output2 + $output3+ $output4 + $output5;
		...
		<img src="images/SM1.jpg" alt="welcome " style="width:100%">
