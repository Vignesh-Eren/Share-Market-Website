...
mysqli_query($db,"UPDATE comd SET product_name='$name', price='$price' ,quantity='$quant',tot='$tot',date='$date' WHERE product_id='$id'");

header("Location:comd.php");
}
...
$id = $_GET['id'];
$result = mysqli_query($db,"SELECT * FROM comd WHERE product_id=".$_GET['id']);
...
<form action="" method="post" action="editcomd.php">
<input type="hidden" name="id" value="<?php echo $id; ?>"/>

<table border="1">
<tr>
<td colspan="2"><b><font color='Red'>Edit Commoditiy </font></b></td>
</tr>
<tr>
