...
mysqli_query($db,"UPDATE stock SET product_name='$name', price='$price' ,quantity='$quant',tot='$tot',date='$date' WHERE product_id='$id'");
...
$id = $_GET['id'];
$result = mysqli_query($db,"SELECT * FROM stock WHERE product_id=".$_GET['id']);
...
<table border="1">
<tr>
<td colspan="2"><b><font color='Red'>Edit Stock </font></b></td>
</tr>
<tr>
<td width="179"><b><font >Stock Name<em>*</em></font></b></td>
<td><label>
...
<tr>
<td width="179"><b><font color='#663300'>Total<em>*</em></font></b></td>
<td><label>
