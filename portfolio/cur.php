...
<body>
    ...
    <div class="page-container">
        ...
        <div class="main-content">
            ...
            <div>
<p>&nbsp;</p>
     <h1 style="text-align:center"><b>ADD CURRENCY HERE</b></h1>
            <p>&nbsp;</p>
			<body>
<form method="POST" class="form-inline" action="addcur.php">
  ...
  <button type="submit" class="btn btn-default" name="add">Add</button>
			...
			<?php
			   ...
			   $query = "SELECT SUM(tot) AS sum FROM `cur` WHERE username='".$_SESSION['username']."'";
               $query_result = mysqli_query($conn , $query);
			   while($row = mysqli_fetch_assoc($query_result)){
				   $output = "Total Investment on Currency : ₹"." ".$row['sum'];
			   }
...
$result = mysqli_query($conn,"SELECT * FROM cur WHERE username='".$_SESSION['username']."'");
?>
...
<p>&nbsp;</p>
<h1><b><CENTER>PORTFOLIO - CURRENCY</b></h1>
<p>&nbsp;</p>
...
<tr>
    ...
    <td><a href="up"Edit></a><a href="editcur.php?id=<?php echo $row["product_id"] ?>"><button type="button" class="btn btn-outline-warning">Edit</button></a> <a href="up"Edit></a><a href="deletecur.php?id=<?php echo $row["product_id"] ?>"><button type="button" class="btn btn-outline-danger">Delete</button></a></td>
</tr>
<?php
$i++;
}
