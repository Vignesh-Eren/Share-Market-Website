...
mysqli_query($db,"UPDATE cur SET product_name='$name', price='$price' ,quantity='$quant',tot='$tot',date='$date' WHERE product_id='$id'");
...
$id = $_GET['id'];
$result = mysqli_query($db,"SELECT * FROM cur WHERE product_id=".$_GET['id']);
...
<form action="" method="post" action="editcur.php">
<input type="hidden" name="id" value="<?php echo $id; ?>"/>

<table border="1">
<tr>
<td colspan="2"><b><font color='Red'>Edit Currency </font></b></td>
</tr>
<tr>
<td width="179"><b><font >Currency<em>*</em></font></b></td>
<td><label>
