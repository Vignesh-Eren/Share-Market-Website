...
<body>
    ...
    <div class="page-container">
        ...
        <div class="main-content">
            ...
            <div>
<p>&nbsp;</p>
     <h1 style="text-align:center"><b>ADD COMMODITIY HERE</b></h1>
            <p>&nbsp;</p>
			<body>
<form method="POST" class="form-inline" action="addcomd.php">
  ...
  <button type="submit" class="btn btn-default" name="add">Add</button>
			...
			<?php
			   ...
			   $query = "SELECT SUM(tot) AS sum FROM `comd` WHERE username='".$_SESSION['username']."'";
               $query_result = mysqli_query($conn , $query);
			   while($row = mysqli_fetch_assoc($query_result)){
				   $output = "Total Investment on Commodities : ₹"." ".$row['sum'];
			   }
			   
			   $sql = "SELECT * FROM comd";
...
$result = mysqli_query($conn,"SELECT * FROM comd WHERE username='".$_SESSION['username']."'");
?>
...
<p>&nbsp;</p>
<h1><b><CENTER>PORTFOLIO - COMMODITIES</b></h1>
<p>&nbsp;</p>
...
<tr>
    ...
    <td><a href="up"Edit></a><a href="editcomd.php?id=<?php echo $row["product_id"] ?>"><button type="button" class="btn btn-outline-warning">Edit</button></a> <a href="up"Edit></a><a href="deletecomd.php?id=<?php echo $row["product_id"] ?>"><button type="button" class="btn btn-outline-danger">Delete</button></a></td>
</tr>
<?php
$i++;
}
