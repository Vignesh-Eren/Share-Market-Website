...
if (isset($_POST['add'])) {
  ...
  $tot=mysqli_real_escape_string($db, $_POST['tot']=$_POST['price']*$_POST['quant']);
  $date=mysqli_real_escape_string($db, $_POST['date']);
  $username=mysqli_real_escape_string($db,$_SESSION['username']);
  
    $query = "INSERT INTO comd (product_name,price,quantity,tot,date,username) 
  			  VALUES('$item_name','$item_price','$quant','$tot','$date','$username')";
