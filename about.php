...
<html>
<head>
  <title>SHARE MARKET - ABOUT</title>
  <meta charset="utf-8">
...
<section class="my-5">
   <div class="py-5">
	 ...
	 <h4 class="text-center">For any Query fill the form with your Login Username and E-Mail ID</h4>
       </div>
 ...
 <div class="py-5">
  ...
  <div class="col-lg-6 col-lg-6 col-12">
     <img src="portfolio/images/SM8.jpg" class="img-fluid aboutimg">
       </div>
	   <div class="col-lg-6 col-lg-6 col-12">
	   <h2 class="display-4" style="font-size:30px;"><b> I am VIGNESH N </b></h2> 
	      <p class="py-3" style="font-size:15px;"><b> I am Student created this website to help people to understand and learn about share market and also people can use portfolio to maintain their investment details.</b>
			 </p>
			  <h2 class="display-4" style="font-size:30px;"><b>Contact: 9487737066 ; 7558180616</b></h2>
        </div>
	</div>
 </div>  
</section>
